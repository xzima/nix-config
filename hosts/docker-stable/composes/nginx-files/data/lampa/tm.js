(function () {
    ...
    //------CUSTOM-CODE-------------------------------------------------------------------------------------------------
    // source https://github.com/lampame/main/blob/main/torrentmanager/torrentmanager.js
    function filterTorrents(list) {
        return list.filter(it => {
            return it.category === Lampa.Storage.get("lmetorrentqBittorentTV")
                || it.category === Lampa.Storage.get("lmetorrentqBittorentMovies");
        });
        //.filter(it=>it.category !== "whisparr");
    }
    //------------------------------------------------------------------------------------------------------------------
        ...
        _GetData$1 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
            ...
            return _regenerator().w(function (_context4) {
                while (1) switch (_context4.n) {
                    ...
                    case 2:
                        torrents = filterTorrents(Object.values(response.torrents)); // CUSTOM-CODE
