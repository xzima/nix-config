...
- настроить хоткеи
  ~~- буфер обмена~~
- настроить визуал dms и обновить настройки по умолчанию
  - обои должны быть привязаны к времени суток
- настроить Stylix при необходимости
- исправить темную тему для модалок в idea
```
